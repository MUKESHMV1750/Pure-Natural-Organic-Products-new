...
<head>
    ...
    <title>Edit Product - Organic Store Admin</title>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            ...
            <div class="admin-info">
                <div class="admin-name"><?php echo htmlspecialchars($_SESSION['username']); ?></div>
        ...
        <div class="sidebar-menu">
            ...
            <a href="../index.php" class="menu-item" target="_blank"><i class="fas fa-external-link-alt"></i><span>View Store</span></a>
        ...
        <div class="form-container">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="editor" class="form-control"><?php echo htmlspecialchars($product['description']); ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div style="margin-top: 10px;">
                        ...
                        <input type="text" name="image_url" class="form-control" value="<?php echo filter_var($product['image'], FILTER_VALIDATE_URL) ? htmlspecialchars($product['image']) : ''; ?>">
                    </div>
                    <?php if($product['image']): ?>
                        <div style="margin-top: 10px;">
                            <p style="margin-bottom: 5px; font-weight: 500;">Current Image:</p>
                            <?php 
                            if (filter_var($product['image'], FILTER_VALIDATE_URL)) {
                                ...
                                $img_src = "https://placehold.co/200x200?text=No+Image";
                            }
                            ?>
                            <img src="<?php echo htmlspecialchars($img_src); ?>" class="current-image" onerror="this.onerror=null; this.src='https://placehold.co/200x200?text=Broken+Image';">
                        </div>
                    <?php endif; ?>
                </div>
